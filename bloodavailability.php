<?php	  
      ...
      if($_POST['Bloodgroup']!="")
       ...
       if($_POST['Bloodgroup']!="")
       $where='where Bloodgroup='."'".$_POST['Bloodgroup']."'";
        $sql="SELECT Name, Gender,DOB,Bloodgroup,Address,City,Mobileno FROM donor WHERE  Bloodgroup LIKE '%" . $Bloodgroup . "%'";   
...
<body>
	...
	<br><br><br><br>
		...
		<th style="background:green"><font color="black">DOB</font></th>
