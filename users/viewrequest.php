...
<nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav">
				 <li class="active"><a href="../users/donorhome.html"><font color="white"><b>Home</b></font></a></li>
	...
	<br><br><br><br><br><br><br><br>
        ...
        <th style="background:green"><font color="black">Requireddate</font></th>
		...
		<th style="background:green"><font color="black">Mobileno</font></th>
			...
			while($sendrequest=mysqli_fetch_array($records))
		    {
				...
				echo "<td style='background:white'>".$sendrequest['Requireddate']."</td>";
