 ...
 <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
				...
				<li role="presentation"><a href="../users/donorhome.html"> <font color="white">Home</font></a></li>
                    </ul><div class="collapse navbar-collapse" id="navcol-1">
                    <ul class="nav navbar-nav navbar-right">
						<li role="presentation"><a href="../users/logout.php"><font color="white"><span class="glyphicon glyphicon-log-out"></span>Logout</font></a></li>
...
$pass=$_REQUEST['Confirmpassword'];
$qury=mysqli_query($conn,"UPDATE donor SET Password='$email',Confirmpassword='$pass' WHERE Username='$name'");
if($qury){
